...
<html lang="en">
  <head>
    ...
    <!-- Main CSS-->
    <link rel="stylesheet" type="text/css" href="{{asset('backend_assests/css/main.css')}}">
    <!-- Font-icon css-->
  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item {{ Request::is('subcategories*') ? 'active' : '' }}" href="{{route('subcategories.index')}}"><i class="app-menu__icon fa fa-file-code-o"></i><span class="app-menu__label">Subategories</span></a></li>
    ...
    <script src="{{asset('backend_assests/js/jquery-3.3.1.min.js')}}"></script>
    <script src="{{asset('backend_assests/js/popper.min.js')}}"></script>
    <script src="{{asset('backend_assests/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('backend_assests/js/main.js')}}"></script>
    <!-- The javascript plugin to display page loading on top-->
    <script src="{{asset('backend_assests/js/plugins/pace.min.js')}}"></script>
    <!-- Page specific javascripts-->
    <script type="text/javascript" src="{{asset('backend_assests/js/plugins/chart.js')}}"></script>
